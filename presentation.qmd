...
- **Sensitivity** score is particularly important - indicates the performance in correctly classifying positive cases. 
- **96%** of the patients with Alzheimer's are correctly identified by our model.
...
::: {.column width="50%"}
#### Lasso
<img src="Lasso.jpg" class="knn-analogy" />
...
#### Random Forest
<img src="Random_Forest.jpg" class="knn-analogy" />
:::
:::
...
rand.forest.function <- function(x) { 
  ...
  CM <- confusionMatrix(test_diagnosis, predicted_labels)
...
data <- data.frame(
  Model = c("Lasso", "kNN", "LDA", "Random Forest"),
  Sensitivity = c(0.8544, 0.9532, 0.9876, 0.9055)
)

# Define colors for each bar
colors <- c("Lasso" = "#E3DED1", "kNN" = "#99A88C", "LDA" = "#335C67", "Random Forest" = "#E09F3E")
...
## Next steps
- Acquire real world data to test further 
- Bring a qualified clinical expert in the loop
