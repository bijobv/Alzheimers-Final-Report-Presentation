...
To create a **right sized** model with **adequate performance** that correctly predicts if the patient has
**Alzheimer's** or **not**.
...
- Symptoms
- [Diagnosis Information (Alzheimer's or No Alzheimers)]{.red}
<br><br><br>
...
**Random Forest emerged as the best model with the highest Sensitivity**

- *Sensitivity* score is particularly important, as it indicates the best performance in correctly classifying positive cases. 
- Our model suggests 96% of the patients with Alzheimer's are correctly identified by our model.
...
### Bar graph of 4 sensitivities measures
...
1. Acquiring real world data to test further 
2. Keep a qualified clinical expert in the loop
3. Investigate additional features associated with Alzheimer's
